...
I currently use it to track my own collection of over 30 named houseplants, several named after people I've lost, and keeping their care history and stories in one place that's actually pleasant to open turned a personal hobby into a real software project. It also let me practice connecting a brand new platform (Flutter/Dart) to an existing cloud architecture I designed myself, which is exactly the kind of cross-platform thinking I want to bring into a professional engineering role.
